...
public class NetmqPublicsher
{
    ...
    public NetmqPublicsher(MessageDelegate messageDelegate)
    {
...
{
    private NetmqPublicsher _netMqListener;
    ...
    private void Start()
    {
        _netMqListener = new NetmqPublicsher(HandleMessage);
